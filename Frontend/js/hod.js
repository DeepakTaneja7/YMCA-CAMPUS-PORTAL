...
async function loadComplaints(session) {
  try {
    const response = await fetch(`https://ymca-campus-portal.onrender.com/api/complaints/department/${session.dept}`);
...
async function updateStatus(id, status) {
  try {
    await fetch(`https://ymca-campus-portal.onrender.com/api/complaints/${id}`, {
      method: 'PUT',
...
async function saveRemark() {
  ...
  try {
    await fetch(`https://ymca-campus-portal.onrender.com/api/complaints/${_remarkTarget}`, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json' },
